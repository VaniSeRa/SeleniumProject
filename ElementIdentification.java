...
public class ElementIdentification extends NavigateClass{

	@Test (priority = 0,groups = { "demo" })
	public void xpathLocator() {
		Navigate("https://ecommerce-playground.lambdatest.io/index.php?route=account/register");
	...
	public void selectsTag() {
		Navigate("https://testsheepnz.github.io/testing-ideas.html");
	...
	public void selectValue() {
		Navigate("https://testsheepnz.github.io/panther.html");
	...
	public void addFunctionality() throws InterruptedException {
		Navigate("https://testsheepnz.github.io/BasicCalculator.html");
